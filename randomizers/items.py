...
def randomize_dungeon_items(self):
  # Places dungeon-specific items first so all the dungeon locations don't get used up by other items.
    ...
    self.logic.set_prerandomization_dungeon_item_location("Forbidden Woods - Vine Maze Right Chest", "FW Small Key")
    ...
    self.logic.set_prerandomization_dungeon_item_location("Forbidden Woods - Vine Maze Left Chest", "FW Compass")
...
def randomize_progression_items(self):
  ...
  self.logic.set_location_to_item("The Great Sea - Ghost Ship", "Triforce Shard 4")
  self.logic.set_location_to_item("Needle Rock Isle - Golden Gunboat", "Triforce Shard 5")
  self.logic.set_location_to_item("Outset Island - Savage Labyrinth - Floor 30", "Triforce Shard 6")

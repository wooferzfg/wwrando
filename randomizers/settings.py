...
DEFAULT_WEIGHTS = {
  ...
  "progression_free_gifts": [(True, 50), (False, 50)],
  ...
  "progression_triforce_charts": [(True, 30), (False, 70)],
  "progression_treasure_charts": [(True, 10), (False, 90)],
  ...
  "progression_savage_labyrinth": [(True, 40), (False, 60)],
  "progression_island_puzzles": [(True, 50), (False, 50)],
  
  "keylunacy": [(True, 50), (False, 50)],
  ...
  "clearer_hints": [(True, 25), (False, 75)],
  ...
  "add_shortcut_warps_between_dungeons": [(True, 50), (False, 50)],
  "do_not_generate_spoiler_log": [(True, 100), (False, 0)],
  "sword_mode": [("Start with Hero's Sword", 50), ("No Starting Sword", 45), ("Swordless", 5)],
  "skip_rematch_bosses": [(True, 95), (False, 5)],
  "race_mode": [(True, 90), (False, 10)],
  "num_race_mode_dungeons": [(1, 5), (2, 15), (3, 25), (4, 30), (5, 15), (6, 10)],
  "randomize_music": [(True, 0), (False, 100)],
  "disable_tingle_chests_with_tingle_bombs": [(True, 0), (False, 100)],
  "starting_gear": [
  ...
  "hint_placement": [("fishmen_hints", 5), ("hoho_hints", 40), ("korl_hints", 55), ("stone_tablet_hints", 0)],
  "num_starting_items": [(0, 30), (1, 40), (2, 20), (3, 10)],
